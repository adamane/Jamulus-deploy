...
docker pull ghcr.io/adamane/jamulus_contakt:3_7_0
mkdir jam
...
sudo docker run \
    ...
    -p 22124:22124/udp \
    -v $(pwd)/jam:/jam \
    ghcr.io/adamane/jamulus_contakt:3_7_0 -n -s -p 22124 -l /jam/jamulus.log -w /jam/welcome.txt -R /jam/recordings --norecord -u 50" > run_server.sh
